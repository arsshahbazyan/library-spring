...
public class UserLogsAspect {
	...
	@Pointcut("execution(* com.epam.learning.library.dao.UserDAOImpl.saveUser(..))")
	public void saveUser() {}
	
	@Pointcut("execution(* com.epam.learning.library.dao.UserDAOImpl.enableUser(..))")
	public void enableUser() {}
	
	@Pointcut("execution(* com.epam.learning.library.dao.UserDAOImpl.disableUser(..))")
	public void disableUser() {}
	
	@Pointcut("execution(* com.epam.learning.library.dao.UserDAOImpl.updateUser(..))")
