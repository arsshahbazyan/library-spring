...
@ComponentScan(basePackages="com.epam.learning.library")
...
public class LibraryConfig implements WebMvcConfigurer {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(){
		...
		entityManager.setPackagesToScan("com.epam.learning.library.entity");
	...
	public JavaMailSender getJavaMailSender() {
	    ...
	    mailSender.setUsername("testlibapp30@gmail.com");
		mailSender.setPassword("733#ghT.,lo0");
